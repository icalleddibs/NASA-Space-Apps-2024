...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function dl(){return new Gn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:bo(),fragmentShader:`
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function fl(){return new Gn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:bo(),fragmentShader:`
...
`].filter(rr).join(`
`)),a=ro(a),a=El(a,e),a=Tl(a,e),o=ro(o),o=El(o,e),o=Tl(o,e),a=bl(a),o=bl(o),e.isRawShaderMaterial!==!0&&(b=`#version 300 es
